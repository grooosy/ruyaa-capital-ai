...
const AIGrid: React.FC<{ startAnimation?: boolean }> = ({
    ...
    <section id="ai" className="w-full max-w-7xl mx-auto py-24 scroll-mt-20">
      <div className="text-center mb-20">
        <div className="flex items-center justify-center gap-4 mb-8">
          ...
          >
            <span className="text-gold text-lg group-hover:animate-bounce">
              ✨
            </span>
          </button>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-start">
        <InteractiveAgentCard
          type="mt"
          onOpenDetails={() => handleOpenDetails("mt")}
        />
        <InteractiveAgentCard
          type="crypto"
          onOpenDetails={() => handleOpenDetails("crypto")}
        />
      </div>
