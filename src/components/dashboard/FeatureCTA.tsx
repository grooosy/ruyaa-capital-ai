  ...
  return (
    ...
    >
      ...
      <span className="flex mb-3">
        <Bolt className="w-7 h-7 text-green-400 drop-shadow-[0_0_8px_#00FF9D]" strokeWidth={2.2} />
      </span>
      <h3 className="text-xl font-bold text-white mb-3 tracking-tight">Unlock &amp; Start Profiting</h3>
      <Button
        onClick={onActivate}
        className="px-8 py-3 rounded-full border-2 border-green-400 shadow-green-glow text-green-200 bg-green-500/10 hover:bg-green-400 hover:text-black focus-visible:ring-2 focus-visible:ring-green-400 font-semibold text-base transition-all"
        tabIndex={0}
