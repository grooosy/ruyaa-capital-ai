...
const FeatureCTA: React.FC<FeatureCTAProps> = ({ onActivate }) => {
  return (
    ...
    >
      ...
      <Button
        onClick={onActivate}
        className="px-8 py-3 rounded-full border-2 border-green-400 text-green-200 bg-green-500/10 hover:bg-green-400 hover:text-black focus-visible:ring-2 focus-visible:ring-green-400 font-semibold text-base transition-colors"
        tabIndex={0}
      >
        Activate Features
      </Button>
